...
export class MovieService {
    movies: Array<any> = [
        {
          ...
          hours:["Wednesday 19:30, 22:30", "Thursday 20:00"],
          room: 1
        }, {
          id: 2,
          title: "The Godfather",
          ...
          hours:["Wednesday 18:30, 22:00", "Thursday 20:00"],
          room: 2
        }, {
          id: 3,
          ...
          hours:["Wednesday 20:00, 22:30", "Thursday 21:00"],
          room: 4
        }, {
          id: 5,
          ...
          hours:["Wednesday 19:00, 22:00", "Thursday 19:00"],
          room: 5
        }
      ];
    ...
    getMovie(id:number):any{
        return this.movies.find(oneMovie => oneMovie.id === Number(id))
    }
